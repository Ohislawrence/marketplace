...
<footer>
    ...
    <div id="footer-bottom-wrap">
        <div id="footer-bottom">
            <p><span>&copy;</span><a href="index-2.html"Acarty</a> Get great deals on apps and more. {{ date('Y') }}</p>
        </div>
    </div>
    <!-- /FOOTER BOTTOM -->
</footer>
